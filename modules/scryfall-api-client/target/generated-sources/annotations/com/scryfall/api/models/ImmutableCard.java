...
public final class ImmutableCard extends AbstractCard {
  ...
  public final ImmutableCard withLayout(@Nullable Layouts value) {
    ...
    if (Objects.equals(this.layout, value)) return this;
    return new ImmutableCard(
        this.id,
        this.name,
        this.oracleId,
  ...
  public final ImmutableCard withRarity(@Nullable Rarity value) {
    ...
    if (Objects.equals(this.rarity, value)) return this;
    return new ImmutableCard(
        this.id,
        this.name,
        this.oracleId,
  ...
  public final ImmutableCard withBorderColor(@Nullable BorderColors value) {
    ...
    if (Objects.equals(this.borderColor, value)) return this;
    return new ImmutableCard(
        this.id,
        this.name,
        this.oracleId,
   ...
   *    .layout(com.scryfall.api.models.Layouts | null) // nullable {@link AbstractCard#layout() layout}
   ...
   *    .colors(List&amp;lt;com.scryfall.api.models.Colors&amp;gt; | null) // nullable {@link AbstractCard#colors() colors}
   *    .colorIndicator(List&amp;lt;com.scryfall.api.models.Colors&amp;gt; | null) // nullable {@link AbstractCard#colorIndicator() colorIndicator}
   *    .colorIdentity(List&amp;lt;com.scryfall.api.models.Colors&amp;gt; | null) // nullable {@link AbstractCard#colorIdentity() colorIdentity}
   *    .allParts(List&amp;lt;com.scryfall.api.models.RelatedCards&amp;gt; | null) // nullable {@link AbstractCard#allParts() allParts}
   *    .cardFaces(List&amp;lt;com.scryfall.api.models.CardFace&amp;gt; | null) // nullable {@link AbstractCard#cardFaces() cardFaces}
   *    .legalities(com.scryfall.api.models.Legality | null) // nullable {@link AbstractCard#legalities() legalities}
   ...
   *    .imageUris(com.scryfall.api.models.ImageUri | null) // nullable {@link AbstractCard#imageUris() imageUris}
   ...
   *    .rarity(com.scryfall.api.models.Rarity | null) // nullable {@link AbstractCard#rarity() rarity}
   ...
   *    .borderColor(com.scryfall.api.models.BorderColors | null) // nullable {@link AbstractCard#borderColor() borderColor}
