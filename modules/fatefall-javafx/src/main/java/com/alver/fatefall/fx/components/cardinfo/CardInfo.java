...
import com.alver.fatefall.CardRepository;
...
public class CardInfo extends VBox {
    public static final URL FXML = CardInfo.class.getResource("card-info.fxml");
    ...
    public void generateImage() {
        runAsync(() -> {
            ...
            try (MagicSetEditorProcess mse = new MagicSetEditorProcess()) {
                mse.load(Path.of("champions.mse-set"));
